...
<body>
    ...
    <div class="main_wrapper">
        ...
        <div class="albums_wrapper albums_wrapper--background">
            <div class="block">
                <form class="admin_form" action="..\Vendor\album_create.php" method="post">
                    <p class="input_title">
                       Назва альбому
                    </p>
                    <textarea class = "input input_article_title" name="album_title"></textarea>

                    <p class="input_title">Обкладинка альбому</p>
                    <textarea class = "input input_article_title" name="album_preview"></textarea>
